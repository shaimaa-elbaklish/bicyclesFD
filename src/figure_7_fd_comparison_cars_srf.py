...
axs[0, 0].scatter(car_agg_df_inner['Density'], car_agg_df_inner['Flow'], label='Cars ($N_p$ = 1)', alpha=0.5, color=c_col_1)
...
axs[1, 0].scatter(car_agg_df_inner['Density'], car_agg_df_inner['Speed'], label='Cars ($N_p$ = 1)', alpha=0.5, color=c_col_1)
...
axs[0, 1].scatter(car_agg_df_inner['Density_Eff_Max'], car_agg_df_inner['Flow_Eff_Max'], label='Cars ($N_p$ = 4)', alpha=0.5, color=c_col_4)
axs[0, 1].scatter(car_agg_df_inner['Density_Eff_Opt'], car_agg_df_inner['Flow_Eff_Opt'], label='Cars ($N_p$ = 2.5)', alpha=0.5, color=c_col_2p5)
axs[0, 1].scatter(car_agg_df_inner['Density_Eff_Avg'], car_agg_df_inner['Flow_Eff_Avg'], label='Cars ($N_p$ = 1.5)', alpha=0.5, color=c_col_1p5)
...
axs[1, 1].scatter(car_agg_df_inner['Density_Eff_Max'], car_agg_df_inner['Speed_Eff_Max'], label='Cars ($N_p$ = 4)', alpha=0.5, color=c_col_4)
axs[1, 1].scatter(car_agg_df_inner['Density_Eff_Opt'], car_agg_df_inner['Speed_Eff_Opt'], label='Cars ($N_p$ = 2.5)', alpha=0.5, color=c_col_2p5)
axs[1, 1].scatter(car_agg_df_inner['Density_Eff_Avg'], car_agg_df_inner['Speed_Eff_Avg'], label='Cars ($N_p$ = 1.5)', alpha=0.5, color=c_col_1p5)
...
axs[0, 2].scatter(car_agg_df_inner['Density_Scaled'], car_agg_df_inner['Flow_Scaled'], label='Cars ($N_p$ = 1)', alpha=0.5, color=c_col_1)
...
axs[1, 2].scatter(car_agg_df_inner['Density_Scaled'], car_agg_df_inner['Speed_Scaled'], label='Cars ($N_p$ = 1)', alpha=0.5, color=c_col_1)
...
fig.tight_layout()
fig.savefig('../figures/BFD_CarsComparison_SRF.pdf', dpi=300, bbox_inches='tight')
sys.exit(1)
